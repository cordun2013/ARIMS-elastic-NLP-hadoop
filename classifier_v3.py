...
test_output = {'fileids':arims_test.filenames, 'pred_categories':arims_test.target}
df = pd.DataFrame(test_output, columns = ['fileids', 'pred_categories'])
print(df.head())
df.to_csv('/Users/catherineordun/Desktop/predicted_categories.csv', header=True, sep=',', encoding='utf-8')
print('The CSV output of the predicted categories has been generated.')
